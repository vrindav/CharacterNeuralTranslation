    ...
    for s in sents:
        ...
        for w in s:
            ...
            if word_len >= max_word_length:
                sentence.append(w[:max_word_length])
            else:
                for char_index in range(word_len, max_word_length):
                    w.append(char_pad_token)
                sentence.append(w)

        if len(s) < max_len:
            for word_index in range(len(sentence), max_len):
                sentence.append([char_pad_token] * max_word_length)
